...
static int bind_gost (ENGINE *e,const char *id)
    ...
    if (!register_ameth_gost(NID_gost89_cbc, &ameth_GostCBC_94, "GOST94-CBC", "GOST R 34.10-94 CBC")) goto end;
...
static int gost_pkey_asn1_meths (ENGINE *e, EVP_PKEY_ASN1_METHOD **ameth,
    ...
    switch (nid)
        ...
        case NID_gost89_cbc: *ameth = ameth_GostCBC_94; return 1;
        default:;
        }
